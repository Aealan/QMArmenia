...
class ClienteController extends Controller {
     ...
     *
     * @Route("/", name="cliente")
     * @Template("QuindimotosProyectoBundle::template.html.twig")
     */
    public function indexAction() {
        ...
        return $this->render('QuindimotosProyectoBundle:Cliente:index.html.twig',array(
            'entities' => $entities,
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('QuindimotosProyectoBundle:Cliente')->find($id);
     ...
     * @Method("POST")
     * @Template("QuindimotosProyectoBundle:Cliente:new.html.twig")
     */
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('moto_new'));
        }
     ...
     * @Method("POST")
     * @Template("QuindimotosProyectoBundle:Cliente:edit.html.twig")
     */
     ...
     * @return string
     */
    public function ajaxNivelAction() {
        ...
        if ($this->getRequest()->isXmlHttpRequest()) {
            ...
            return $this->render('QuindimotosProyectoBundle:Cliente:ciudad.html.twig', array(
                        'ciudades' => $ciudades
                    ));
        }
    }
