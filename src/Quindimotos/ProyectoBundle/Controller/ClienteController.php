        ...
        if ($this->getRequest()->isXmlHttpRequest()) {
           ...
           /* $resp="";
            foreach ($ciudades as $ciudad) {
                $resp[]=array('id' => $ciudad->getId(), 'nombre' => $ciudad->getNombre());
            }
