...
class RoleController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QuindimotosProyectoBundle:Role')->find($id);
     ...
     * @Method("POST")
     * @Template("QuindimotosProyectoBundle:Role:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("QuindimotosProyectoBundle:Role:edit.html.twig")
     */
